...
import cn.entgroup.dao.RedisConn;
import cn.entgroup.scheduler.RedisScheduler;
import cn.entgroup.scheduler.UrlFactory;
import cn.entgroup.utils.DateUtil;
import cn.entgroup.utils.NetUtil;
...
public class EnDistriSpider extends Spider {
	...
	private void initCronExp() {
		if (cronExp == null || cronExp.length() == 0) {
			this.cronExp = DateUtil.getStringByDate(new Date());
		}
	}
